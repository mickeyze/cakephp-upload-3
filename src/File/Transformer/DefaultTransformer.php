<?php
namespace Wirebids\Upload\File\Transformer;

use Cake\ORM\Entity;
use Cake\ORM\Table;
use Wirebids\Upload\File\Transformer\TransformerInterface;
...
class DefaultTransformer implements TransformerInterface
{
     ...
     *
     *   [
     *     '/tmp/path/to/file/on/disk' => ['name' => 'file.pdf', 'shape' => 'original'],
     *     '/tmp/path/to/file/on/disk-2' => ['name' => 'file-preview.png', 'shape' => 'preview'],
     *   ]
     *
    ...
    {
        return [$this->data['tmp_name'] => ['name' => $this->data['name'], 'type' => $this->data['type']]];
    }
}
