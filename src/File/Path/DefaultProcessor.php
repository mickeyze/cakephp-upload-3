<?php
namespace Wirebids\Upload\File\Path;

use Cake\ORM\Entity;
use Cake\ORM\Table;
use Wirebids\Upload\File\Path\Basepath\DefaultTrait as BasepathTrait;
use Wirebids\Upload\File\Path\Filename\DefaultTrait as FilenameTrait;
