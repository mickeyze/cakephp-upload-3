<?php
namespace Wirebids\Upload\Test\TestCase\File\Writer;
...
class DefaultWriterTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Wirebids\Upload\File\Writer\WriterInterface', $this->writer);
    }
    ...
    public function testDelete()
    {
        ...
        $writer = $this->getMock('Wirebids\Upload\File\Writer\DefaultWriter', ['getFilesystem'], [$this->table, $this->entity, $this->data, $this->field, $this->settings]);
