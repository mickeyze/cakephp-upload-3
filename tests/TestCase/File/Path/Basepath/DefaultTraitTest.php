<?php
namespace Wirebids\Upload\Test\TestCase\File\Path\Basepath;

use Cake\ORM\Entity;
use Cake\ORM\Table;
use Cake\TestSuite\TestCase;
use Wirebids\Upload\File\Path\Basepath\DefaultTrait;

class DefaultTraitTest extends TestCase
{
    public function testNoSpecialConfiguration()
    {
        $mock = $this->getMockForTrait('Wirebids\Upload\File\Path\Basepath\DefaultTrait');
