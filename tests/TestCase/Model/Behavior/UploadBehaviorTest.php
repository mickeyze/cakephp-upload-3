<?php
namespace Wirebids\Upload\Test\TestCase\Model\Behavior;
...
use Wirebids\Upload\Test\Stub\ChildBehavior;
use ReflectionClass;

class UploadBehaviorTest extends TestCase
{
    public $fixtures = [
        'plugin.Wirebids/Upload.Files',
    ];
    ...
    public function setup()
    {
        ...
        $this->processor = $this->getMock('Wirebids\Upload\File\Path\DefaultProcessor', [], [$this->table, $this->entity, $this->dataOk, $this->field, $this->settings]);
        $this->writer = $this->getMock('Wirebids\Upload\File\Writer\DefaultWriter', [], [$this->table, $this->entity, $this->dataOk, $this->field, $this->settings]);
        $this->behaviorMethods = get_class_methods('Wirebids\Upload\Model\Behavior\UploadBehavior');
    }
    ...
    public function testInitialize()
    {
        ...
        $behavior = $this->getMock('Wirebids\Upload\Model\Behavior\UploadBehavior', $methods, [$table, $this->settings], '', false);
    ...
    {
        $table = TableRegistry::get('Wirebids/Upload.Files');
    ...
    public function testInitializeIndexedConfig()
    {
        ...
        $behavior = $this->getMock('Wirebids\Upload\Model\Behavior\UploadBehavior', $methods, [$table, $settings], '', false);
        $reflection = new ReflectionClass($behavior);
        $property = $reflection->getProperty('_table');
        $property->setAccessible(true);
        $property->setValue($behavior, $table);
    ...
    {
        $settings = [
            'className' => 'Wirebids\Upload\Model\Behavior\UploadBehavior',
            'field' => []
        ];
        $table = $this->getMock('Cake\ORM\Table');
        $schema = $this->getMock('Cake\Database\Schema\Table', [], [$table, []]);
    ...
    public function testBeforeMarshalOk()
    {
        ...
        $behavior = $this->getMock('Wirebids\Upload\Model\Behavior\UploadBehavior', $methods, [$table, $this->settings]);
    ...
    public function testBeforeSaveUploadError()
    {
        ...
        $behavior = $this->getMock('Wirebids\Upload\Model\Behavior\UploadBehavior', $methods, [$this->table, $this->settings]);
    ...
    public function testAfterDeleteOk()
    {
        ...
        $behavior = $this->getMock('Wirebids\Upload\Model\Behavior\UploadBehavior', $methods, [$this->table, $this->dataOk]);
    ...
    {
        $methods = array_diff($this->behaviorMethods, ['config', 'afterDelete']);
        $behavior = $this->getMock('Wirebids\Upload\Model\Behavior\UploadBehavior', $methods, [$this->table, $this->dataError]);
    ...
    public function testGetWriter()
    {
        ...
        $this->assertInstanceOf('Wirebids\Upload\File\Writer\WriterInterface', $processor);
    }
